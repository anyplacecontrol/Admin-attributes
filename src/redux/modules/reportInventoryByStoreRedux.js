import * as reportInventoryByStoreApi from "../../api/reportInventoryByStoreApi"; 
...
//*******************************************************************************
const PREFIX = "reportInventoryByStore/";
//*******************************************************************************

export const reportInventoryByStoreInitialState = {
  ...BaseReportInitialState,
  columns: tableColumns.INVENTORY_BY_STORE_COLUMNS,
  sortBy: tableColumns.COLUMN_EXPIRING,
  sortOrder: "ascending" 
};

//*******************************************************************************

export default function reducer(state = reportInventoryByStoreInitialState, action = {}) {
  let result = BaseReportReducer(
    PREFIX,
    state,
    action,
    reportInventoryByStoreInitialState
  );
...
class ReportInventoryByStoreActions extends BaseReportActions {
  // ABSTRACT ACTIONS REALIZATION

  // *** Fetch
  _fetchItemsFromNetwork(filter) {
    return async (dispatch, getState) => {
      let fetchedResponse = await reportInventoryByStoreApi.getReport_InventoryByStore(filter);
  ...
  _getStateSlice = state => {
    return state.reportInventoryByStore;
  };
...
export const reportInventoryByStoreActions = new ReportInventoryByStoreActions();
